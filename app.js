...
let tasker = {
    ...
    buildTask: function () {
        let taskListItem, taskMarkContainer, taskCompleted, taskValueContainer, taskValue, taskDeleteContainer, taskDelete;
        taskListItem = document.createElement("li");

        // chekmark
        taskMarkContainer = document.createElement("span");
        taskMarkContainer.setAttribute("class", "mark");
        taskCompleted = document.createElement("i");
        taskCompleted.setAttribute("class", "gg-check-o");
        ...
        taskDelete.setAttribute("class", "gg-trash");
    ...
    scanTaskList: function () {
        ...
        for (i = 0; i < this.taskListChildren.length; i++) {
            ...
            markIcon = taskListItem.getElementsByClassName("mark")[0];
...
var date = today.getDate() + ' ' + today.toLocaleString('default', {
    month: 'short'
}) + ', ' + today.getFullYear();
